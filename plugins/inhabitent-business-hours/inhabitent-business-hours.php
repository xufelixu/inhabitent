 ...
 *
 * @package   Widget_Name
 * @author    Felixu <deepcovetrading@gmail.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2018 inhabitent-business-hours
 *
 * @wordpress-plugin  inhabitent business hours
 * Plugin Name:       inhabitent-business-hours
 * Plugin URI:        inhabitent-business-hours
 * Description:       inhabitent-business-hours
 * Version:           1.0.0
 * Author:            Felixu
 * Author URI:        inhabitent-business-hours
 * License:           GPL-2.0+
...
class inhabitent_business_hours extends WP_Widget {
	...
	public function __construct() {
		...
		parent::__construct(
			...
			array(
				...
				'description' => 'inhabitent business hours on sidebar'
			)
		);
	...
	public function widget( $args, $instance ) {
		...
		// Manipulate the widget's values based on their input fields apply_filter=you can changed it 
		...
		include( plugin_dir_path( __FILE__ ) . 'views/widget.php' );//html 
		$widget_string .= ob_get_clean();
		$widget_string .= $after_widget;

		print $widget_string;

	} // end widget ob_get_clean to run the code from ob_start to ob_get_clean();
	...
	public function form( $instance ) {
		...
		include( plugin_dir_path( __FILE__ ) . 'views/admin.php' );//inside the fold 
